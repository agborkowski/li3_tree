...
class Model extends \lithium\data\Model {
	...
	public static function __init($options = array()) {
		...
		static::$_tree_config[$class] = static::$_tree_defaults;
	}
	 ...
	 */
	public static function countChildren($id, $recursive = false) {
	 ...
	 */
	public static function getChildren($id, $recursive = false, $options = array()) {
		$self = get_called_class();
		extract(static::$_tree_config[$self]);;
		if ($recursive) {
